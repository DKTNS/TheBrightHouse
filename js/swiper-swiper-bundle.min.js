      ...
      function $() {
        ...
        m.$slideEl ||
          ...
          m.$imageEl &&
            ...
            (e.scale = 1),
            (p = 1),
            m.$imageWrapEl.transition(200).transform("translate3d(0,0,0)"),
            m.$imageEl.transition(200).transform("translate3d(0,0,0) scale(1)"),
        ...
        E = () => {
          ...
          const a = t.$wrapperEl,
            r =
              e.id ||
              a.attr("id") ||
              `swiper-wrapper-${((n = 10), void 0 === n && (n = 10), "x".repeat(n).replace(/x/g, () => Math.round(10 * Math.random()).toString(16)))}`;
          var n;
          const l =
                  ...
                  if (d.velocities.length > 1) {
                    ...
                    (t.velocity = a / i),
                      ...
                      Math.abs(t.velocity) < r.freeMode.minimumVelocity &&
                        (t.velocity = 0),
                      (i > 150 || u() - e.time > 200) && (t.velocity = 0);
                  } else t.velocity = 0;
