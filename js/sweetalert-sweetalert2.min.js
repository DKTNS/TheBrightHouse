!(function (t, e) {
  ...
  var P,
    ...
    rt = '\n <div aria-labelledby="'
      ...
      .replace(/(^|\n)\s*/g, ""),
    at = function (t) {
      Jt.isVisible() && P !== t.target.value && Jt.resetValidationMessage(),
        (P = t.target.value);
    },
    st = function (t) {
      var e;
      if (
        ...
        g.appendChild(n),
          (i = t),
          (r = U()).setAttribute("role", i.toast ? "alert" : "dialog"),
          r.setAttribute("aria-live", i.toast ? "polite" : "assertive"),
          i.toast || r.setAttribute("aria-modal", "true"),
          (a = g),
          "rtl" === window.getComputedStyle(a).direction && O(R(), x.rtl),
          (s = K()),
          (c = M(s, x.input)),
          (u = M(s, x.file)),
    ...
    dt = function (t) {
      ...
      t.html
        ? (ct(t.html, e), j(e, "block"))
        : t.text
          ? ((e.textContent = t.text), j(e, "block"))
          : q(e),
        (function (e) {
          for (
            var t,
            ...
            (s.className = a),
              e.inputClass && O(s, e.inputClass),
              e.customClass && O(s, e.customClass.input),
              q(s);
          }
          switch (e.input) {
            case "text":
    ...
    mt = function (c) {
      ...
      l >= c.progressSteps.length &&
        ...
        c.progressSteps.forEach(function (t, e) {
          ...
          if (
            (u.appendChild(a),
            e === l && O(a, x["active-progress-step"]),
            e !== c.progressSteps.length - 1)
          ) {
            var s =
              ((i = t),
              (r = document.createElement("li")),
              O(r, x["progress-step-line"]),
      ...
      S(r, t.customClass, "header"),
        ...
        (function (t) {
          ...
          if (e && e.classList.contains(g[t.type])) S(e, t.customClass, "icon");
            ...
            if ((ft(), -1 !== Object.keys(g).indexOf(t.type))) {
              ...
              j(n),
                S(n, t.customClass, "icon"),
                E(n, "swal2-animate-".concat(t.type, "-icon"), t.animation);
            } else
              k(
        ...
        (function (t) {
          ...
          j(e),
            ...
            (e.className = x.image),
            S(e, t.customClass, "image"),
            t.imageClass && O(e, t.imageClass);
        })(t),
        (e = t),
        (n = W()),
        H(n, e.title || e.titleText),
        e.title && ct(e.title, n),
        e.titleText && (n.innerText = e.titleText),
        S(n, e.customClass, "title"),
        (o = t),
        (i = tt()),
        S(i, o.customClass, "closeButton"),
        H(i, o.showCloseButton),
    ...
    ht = function (t) {
      ...
      (e = t),
        ...
        (n.className = x.popup),
        e.toast
          ? (O([document.documentElement, document.body], x["toast-shown"]),
            O(n, x.toast))
          : O(n, x.modal),
        ...
        (function (t) {
          ...
          if (e) {
            ...
            S(e, t.customClass, "container"),
              t.customContainerClass && O(e, t.customContainerClass);
          }
        })(t),
        gt(t),
        dt(t),
        (function (t) {
          var e = J(),
            ...
            o = $();
          if (
            (t.showConfirmButton || t.showCancelButton ? j(e) : q(e),
            S(e, t.customClass, "actions"),
            H(n, t.showConfirmButton, "inline-block"),
            H(o, t.showCancelButton, "inline-block"),
            ...
            S(n, t.customClass, "confirmButton"),
            O(n, t.confirmButtonClass),
            (o.className = x.cancel),
            S(o, t.customClass, "cancelButton"),
            O(o, t.cancelButtonClass),
            t.buttonsStyling)
          ) {
            O([n, o], x.styled),
        ...
        (i = G()),
        H(i, o.footer),
        o.footer && ct(o.footer, i),
        S(i, o.customClass, "footer");
    };
  var vt = [],
    bt = function () {
      var t = U();
  ...
  var Ot = function () {
    ...
    It = { swalPromiseResolve: new WeakMap() };
  function Rt(t, e) {
    ot()
      ? Ut(e)
      : (wt().then(function () {
  ...
  function Dt(t) {
    ...
    n &&
      ...
      T(n, x.show),
      O(n, x.hide),
      lt && !y(n, x.noanimation)
        ? n.addEventListener(lt, Nt.bind(null, n, e, a))
        : Rt(e, a),
      i(t || {}));
  }
  var Ut = function (t) {
  ...
  var Ft = function (t) {
      ...
      null !== t.onBeforeOpen &&
        ...
        t.onBeforeOpen(n),
        t.animation ? (O(n, x.show), O(e, x.fade), T(n, x.hide)) : T(n, x.fade),
        j(n),
        (e.style.overflowY = "hidden"),
        lt && !y(n, x.noanimation)
          ? n.addEventListener(lt, function t() {
              n.removeEventListener(lt, t), (e.style.overflowY = "auto");
            })
          : (e.style.overflowY = "auto"),
        O([document.documentElement, document.body, e], x.shown),
        t.heightAuto &&
          t.backdrop &&
          !t.toast &&
          O([document.documentElement, document.body], x["height-auto"]),
        nt() &&
          (t.scrollbarPadding && Ot(),
          (function () {
            if (
              /iPad|iPhone|iPod/.test(navigator.userAgent) &&
              !window.MSStream &&
              !y(document.body, x.iosfix)
            ) {
    ...
    Yt = Object.freeze({
      ...
      getProgressSteps: function () {
        return (
          ...
          Lt.innerParams.get(this).progressSteps
        );
      },
      setProgressSteps: function (t) {
        h("Swal.setProgressSteps()", "Swal.update()");
        var e = a({}, Lt.innerParams.get(this), { progressSteps: t });
      ...
      _main: function (t) {
        ...
        !(function (t) {
          for (var e in t)
            St((i = e)) || C('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e),
                -1 !== xt.indexOf(o) &&
                  C(
        ...
        return new Promise(function (t) {
          ...
          It.swalPromiseResolve.set(p, t),
            f.timer &&
              (yt.timeout = new Wt(function () {
          ...
          var a = function (t, e) {
            for (var n = et(f.focusCancel), o = 0; o < n.length; o++)
              return (
                (t += e) === n.length
                  ? (t = 0)
                  : -1 === t && (t = n.length - 1),
          ...
          if (
            (yt.keydownHandlerAdded &&
              (yt.keydownTarget.removeEventListener(
                "keydown",
                yt.keydownHandler,
                { capture: yt.keydownListenerCapture }
              ),
            ...
            f.toast ||
              ((yt.keydownHandler = function (t) {
                return (function (t, e) {
                  if (
                    ...
                    if ("Tab" === t.key) {
                      for (
                        var n = t.target, o = et(e.focusCancel), i = -1, r = 0;
                        r < o.length;
                        r++
                      )
                        if (n === o[r]) {
              ...
              (yt.keydownTarget = f.keydownListenerCapture ? window : m.popup),
              (yt.keydownListenerCapture = f.keydownListenerCapture),
              yt.keydownTarget.addEventListener("keydown", yt.keydownHandler, {
                capture: yt.keydownListenerCapture,
              }),
              (yt.keydownHandlerAdded = !0)),
            p.enableButtons(),
            p.hideLoading(),
            p.resetValidationMessage(),
            f.toast && (f.input || f.footer || f.showCloseButton)
              ? O(document.body, x["toast-column"])
              : T(document.body, x["toast-column"]),
          ...
          Ft(f),
            f.toast ||
              (v(f.allowEnterKey)
                ? f.focusCancel && I(m.cancelButton)
                  ? m.cancelButton.focus()
                  : f.focusConfirm && I(m.confirmButton)
                    ? m.confirmButton.focus()
                    : a(-1, 1)
